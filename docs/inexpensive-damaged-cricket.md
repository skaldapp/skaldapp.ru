---
title: Skald
description: Создавайте заметки, статьи и базы знаний в интуитивном визуальном редакторе. Публикуйте результат в один клик — или просто работайте локально. Сложные инструменты подключаются только тогда, когда они вам нужны.
attrs:
  un-cloak: true
  class:
    - max-w-none
