---
title: Напишите в Markdown. Скопируйте на сервер. Сайт работает.
titleTemplate: Skald - %s
description: Создавайте заметки, статьи и базы знаний в интуитивном визуальном редакторе. Публикуйте результат простым копированием или просто работайте локально. Сложные инструменты подключаются только тогда, когда они вам нужны.
attrs:
  un-cloak: true
  class:
    - max-w-none
