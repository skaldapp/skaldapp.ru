...
:elAlert{.not-prose title="Наследование метаданных" type="primary" description="Дочерние страницы наследуют метаданные от родительской страницы. К примеру, если в родительской странице указан importmap, то он будет доступен и в дочерних страницах." show-icon :closable="false"}
